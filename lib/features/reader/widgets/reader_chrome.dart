...
/// Immersive reader chrome: a top bar (back, title, mode/fit/options menus;
/// capture, direction toggle, and the double-page nudge live in the options
/// menu) plus a bottom thumbnail scrubber. The scrubber works in page space, is
/// RTL-aware (page 1 sits on the right in right-to-left modes), and shows a
/// live page-thumbnail preview while dragging.
