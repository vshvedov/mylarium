...
class Captures extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Captures(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  Captures createAlias(String alias) {
    return Captures(attachedDatabase, alias);
  }
}
...
class LocalComics extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  LocalComics(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> readingDirection = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const CustomExpression('\'ltr\''),
  );
  ...
  @override
  LocalComics createAlias(String alias) {
    return LocalComics(attachedDatabase, alias);
  }
}
...
class Pins extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  Pins(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> sourceId = GeneratedColumn<String>(
    'source_id',
    aliasedName,
    false,
  ...
  @override
  Pins createAlias(String alias) {
    return Pins(attachedDatabase, alias);
  }
}

class HomeRailItems extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  HomeRailItems(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> sourceId = GeneratedColumn<String>(
    'source_id',
    aliasedName,
    false,
  ...
  @override
  HomeRailItems createAlias(String alias) {
    return HomeRailItems(attachedDatabase, alias);
  }
}
...
class DatabaseAtV20 extends GeneratedDatabase {
  ...
  late final Captures captures = Captures(this);
  late final LibraryPrefs libraryPrefs = LibraryPrefs(this);
  late final LocalComics localComics = LocalComics(this);
  ...
  late final Pins pins = Pins(this);
  late final HomeRailItems homeRailItems = HomeRailItems(this);
